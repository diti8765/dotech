...
<html lang="en" dir="ltr">
  ...
  <body style="background:url('images/629271.jpg') no-repeat center center fixed;">
    <!-- Navbar -->
    <nav class="navbar navbar-expand-lg" style="background-color:#fafaf7;">
  		<div class="container-fluid">
  			<a class="navbar-brand" href="index.php"><h1 style="color:black;"><b><i>Messmate</i></b></h1></a>
    ...
    <img src="images/Cooking-Quote-Laughter-is-brightest-in-the-place-where-food-is-good.webp">
    <!-- </div>
    </div>
    </div> -->
    <div class="container">
